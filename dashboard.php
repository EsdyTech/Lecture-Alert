                ...
                <div class="row">
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $courses;?></h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Time-table</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $timetable;?></h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Lecturers</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $lecturers;?></h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $users;?></h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span>
                            </div>
